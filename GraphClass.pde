   ...
   /*  =========================================================================================
      ...
      void LineGraph(float[] x ,float[] y) {
         ...
         for (int i=0; i<(x.length-1); i++){
           strokeWeight(2);stroke(GraphColor);noFill();smooth();
           if (yPos+Height-(y[i]/(yMax-yMin)*Height)+(yMin)/(yMax-yMin)*Height < yPos ||  yPos+Height-(y[i+1]/(yMax-yMin)*Height)+(yMin)/(yMax-yMin)*Height < yPos ||
               yPos+Height-(y[i]/(yMax-yMin)*Height)+(yMin)/(yMax-yMin)*Height > yPos+ Height || yPos+Height-(y[i+1]/(yMax-yMin)*Height)+(yMin)/(yMax-yMin)*Height > yPos + Height) continue;
